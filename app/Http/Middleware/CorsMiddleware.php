...
class CorsMiddleware
{
    ...
    public function handle(Request $request, \Closure $next)
    {
        $this->headers = [
            ...
            'Access-Control-Expose-Headers' => 'Authorization' //通常还需要获取服务端返回的Authorization认证信息，但是Authorization信息，并不在浏览器默认允许获取范围内，所以要获取Authorization认证信息，需要服务端设置 "Access-Control-Expose-Headers" = 'Authorization' 才行
        ];
        $this->allow_origin = [
            'http://localhost:9527',
            'http://127.0.0.1:9527',
            'http://192.168.2.92:9527',
            'http://127.0.0.1:8080',
            'http://192.168.31.143:8089',
            'http://192.168.199.66:9527'
        ];
